...
const umi = createUmi(process.env.TOKEN_SERVER_SOLANA_ENDPOINT || 'https://api.mainnet-beta.solana.com').use(mplTokenMetadata());
...
class Token {
    ...
    constructor(address: string, name: string, symbol: string, decimals: number, supply: string) {
